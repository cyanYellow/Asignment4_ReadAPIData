                ...
                ZStack(alignment: .bottomTrailing){
                    ...
                    VStack{
                        ...
                        Form{
                            ...
                            Stepper(
                            String(appViewModel.year),
                            value: $appViewModel.year,
                            in: appViewModel.yearRange,
                            step: appViewModel.step
                            )
                            }
                            .id(topID)
                            ...
                            Stepper(
                            String(appViewModel.week),
                            value: $appViewModel.week,
                            in: appViewModel.weekRange,
                            step: appViewModel.step
                            )
                            }
                            ...
                            List(appViewModel.allRanks){ allRank in
